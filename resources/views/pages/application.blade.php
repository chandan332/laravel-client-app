    ...
    <div class="row">
        <div class="col-md-4">
            <div class="h-100 d-flex flex-column justify-content-center align-items-center gap-2 text-center ">
                ...
                <h3 class="fw-semibold">Package Starts from <br/><span class="text-danger text-decoration-line-through">₹1999</span> ₹999</h3>
                <p class="">The fastest FSSAI registration portal online, hands down. Application for 50,000 Food Licenses Completed Since 2023.</p>
            </div>
        </div>
    ...
    <div class="row gap-2 mt-4">
        <div class="col tw-max-w-[1024px] m-auto">
            ...
            <div class="tw-flex tw-flex-col tw-items-center mt-4 overflow-y-auto">
                ...
                <!-- <img src="{{ Vite::image('certificate/2.jpg') }}" alt="" class="img-fluid"> -->
                <!-- <img src="{{ Vite::image('certificate/3.jpg') }}" alt="" class="img-fluid">
                <img src="{{ Vite::image('certificate/4.jpg') }}" alt="" class="img-fluid">
                <img src="{{ Vite::image('certificate/5.jpg') }}" alt="" class="img-fluid"> -->
            </div>
        </div>
    </div>
    
    <div>
            <h1 class="col-md-10 m-auto mt-4 text-center fw-bold">How To do Your Fssai Registration through <br/><span class="text-danger">Legal Success India?</span></h1>
        <div class="row g-4">
